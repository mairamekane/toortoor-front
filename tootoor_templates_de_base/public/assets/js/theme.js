...
var redirectToDocs = function redirectToDocs(id) {
  ...
  input && input.addEventListener('change', function (e) {
    ...
    isChecked ? location.replace(getData(el, 'page-url')) : location.replace(getData(el, 'home-url'));
  });
};

var redirectToNavbarDocs = function redirectToNavbarDocs(selector) {
